...
TRAIN_DIR = 'C:/Users/gvadakku/Desktop/final_software_cnn_play/images/cnn_training_testing_data/train'
TEST_DIR = 'C:/Users/gvadakku/Desktop/final_software_cnn_play/images/cnn_training_testing_data/test'
IMG_SIZE_W = 32
IMG_SIZE_H = 64
...
def label_img(img):
    ...
    # DIY One hot encoder
    if word_label[0:3] == 'Gre': return [1, 0, 0]
    elif word_label[0:3] == 'Red': return [0, 1, 0]
    else: return [0, 0, 1]
