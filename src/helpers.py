...
def read_directory_images(path, extension, n=None):
    ...
    :param extension: The image extension i.e '.png', '.jpg', etc.,.jpg by default
...
def validate_image_directory(path, extension):
    """ Clean up empty images in a directory. Happens surprisingly often when importing a data-set """
