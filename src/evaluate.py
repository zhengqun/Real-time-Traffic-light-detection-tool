...
"""All the below methods are to evaluate SVM-classifier for its matrices and not for the overall tool chain"""


def evaluate_model(classifier, images, labels):
    """ Output the key metrics of a trained classifier (SVM based)"""
